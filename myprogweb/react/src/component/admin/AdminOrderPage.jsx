...
const AdminOrdersPage = () => {
    ...
    // Stabilizza la funzione fetchOrders usando useCallback
    ...
    }, [searchStatus, currentPage]); // Dipendenze corrette per garantire sincronizzazione

    useEffect(() => {
        fetchOrders(); // La funzione è stabile, quindi nessun errore da ESLint
    }, [fetchOrders]);
